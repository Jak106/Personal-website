    ...
    if (game) {
        if (empty.length != 0) {
            ...
            if (availPattern.length != 0) {
                ...
                document.getElementById(String.fromCharCode(availPattern[0][0], availPattern[0][1])).style.backgroundImage = "url('iconmonstr-x-mark-lined-240.png')"
            } else if (defeat.length != 0) {
                document.getElementById(String.fromCharCode(defeat[0][0], defeat[0][1])).innerHTML = "x"
                document.getElementById(String.fromCharCode(defeat[0][0], defeat[0][1])).style.backgroundImage = "url('iconmonstr-x-mark-lined-240.png')"
                ...
                document.getElementById(String.fromCharCode(empty[field][0], empty[field][1])).style.backgroundImage = "url('iconmonstr-x-mark-lined-240.png')"
            }
        } else {
    ...
    td[x].addEventListener("click", (e) => {
        ...
        if (game) {
            if (e.target.innerHTML != "x" && e.target.innerHTML != "o" ) {
                ...
                e.target.style.backgroundImage = 'url("iconmonstr-circle-lined-240.png")'
