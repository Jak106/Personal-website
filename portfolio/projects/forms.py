...
class ProjectForm(forms.ModelForm):
    ...
    organization = forms.CharField(label='', max_length=50, required=False, widget=forms.TextInput(attrs = {'class': 'heading-text', 'id':'heading-org', 'placeholder': 'Organization'} ))
